...
//    @GetMapping("/category/edit/{categoriesNo}")
//    public String editCategoryForm(@PathVariable Long categoriesNo, Model model) {
//        CategoryDTO categoryDTO = categoryService.getCategoryById(categoriesNo);
//        List<BoardDTO> boards = boardService.getBoardsByCategory(categoryDTO);
