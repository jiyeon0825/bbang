...
public class PostController {
    ...
    public String postList(Model model,
        ...
        // page : default 페이지, size: 한 페이지 글 개수, sort: 정렬 기준, direction: 정렬 순서
        // post/list?page=0&size=20
        // post/list?searchKeyword=test
        // post/list?categoriesNo=1
        // post/list?boardNo=1
...
//    }
    ...
    private void pagingPost(Model model, Page<PostDTO> list) {
        ...
        int pageGroup = (nowPage - 1) / 5; // Page group based on 3 pages at a time
        int startPage = pageGroup * 5 + 1;
        int endPage = Math.min(startPage + 4, totalPage); // Ensure endPage does not exceed totalPage

        // Adjusting to ensure correct navigation when clicking the arrow
